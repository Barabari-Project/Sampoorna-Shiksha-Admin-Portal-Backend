...
export const addSchoolData = expressAsyncHandler(async (req, res) => {
...
export const updateSchoolData = expressAsyncHandler(async (req, res) => {
...
export const getSchools = expressAsyncHandler(async (req, res) => {
...
export const getSchoolById = expressAsyncHandler(async (req, res) => {
...
export const deleteSchoolById = expressAsyncHandler(async (req, res) => {
    const { id } = req.params; // Extract the school ID from the request parameters
    checkMogooseId(id, 'School');
