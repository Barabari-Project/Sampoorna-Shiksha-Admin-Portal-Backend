...
export const placeOrderToSchool = expressAsyncHandler(async (req, res) => {
...
export const getOrderBySchoolId = expressAsyncHandler(async (req, res) => {
...
//# sourceMappingURL=schoolOrderController.js.map